...
class APIController extends Controller {
    ...
    public function getList(){
        ...
        return response(['data' => json_decode(file_get_contents('https://api.toornament.com/organizer/v2/tournaments/3784327726246748160/registrations'), true), 'featured' => $featured])
